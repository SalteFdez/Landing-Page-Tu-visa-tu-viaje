...
export default function WorkingHolidaySection() {
  ...
  const workingHolidayInfo = {
    ...
    description:
      "Una visa Working Holiday es tu billete de ida para vivir una experiencia única combinando trabajo y viaje en el extranjero. Es la oportunidad perfecta para explorar nuevos países mientras generas ingresos y desarrollas habilidades profesionales.",
    longDescription:
  ...
  const keyFeatures = [
    {
      ...
      title: "Rango de Edad",
      description:
        "Entre 18 y 35 años de edad, dependiendo del destino elegido",
      badges: ["18", "35"],
    ...
    },
    {
      ...
      description:
        "Hasta 12 meses de estadía, con posibilidad de extensión en algunos países",
      badges: ["12 meses"],
    ...
    },
    {
      ...
      description:
        "Tu nacionalidad determina los destinos disponibles, no tu lugar de residencia",
      badges: ["Nacionalidad"],
    ...
    },
    {
      ...
      description:
        "Puedes trabajar en cualquier sector: desde tu profesión hasta trabajos temporales",
      badges: ["Flexible"],
    ...
    },
    {
      ...
      description:
        "Gestiona tu visa directamente online, sin agencias costosas",
      badges: ["Directo"],
  ...
  return (
    <div ref={sectionRef} className="relative overflow-hidden">
      ...
      <section
        ref={heroRef}
        className="relative bg-gradient-to-br from-cream via-orange-50 to-light-coral px-4 py-12 md:py-20 lg:py-32"
      >
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="mb-4 md:mb-8">
            <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent mb-4 pt-3 md:mb-6 pb-[12px] leading-normal">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center">
            <a href="#destinos">
              <Button className="bg-gradient-to-r from-[#E9744C] to-[#EFA297] hover:from-[#d36945] hover:to-[#ca8b81] text-white px-6 py-3 md:px-8 md:py-4 text-base md:text-lg font-semibold rounded-xl md:rounded-2xl shadow-lg md:shadow-xl hover:shadow-xl md:hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center mb-12 md:mb-20">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Combina trabajo y viaje en un solo programa
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-green-500 rounded-full flex items-center justify-center mt-0.5 md:mt-1">
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Desarrolla habilidades profesionales internacionales
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-green-500 rounded-full flex items-center justify-center mt-0.5 md:mt-1">
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Construye una red de contactos global
                  </p>
                </div>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="relative">
                <div className="text-7xl md:text-9xl rounded-r-full md:rounded-3xl overflow-hidden">
                  <img src="/assets/pasajeros.png" alt="Pasajeros" />
                </div>
          ...
          <div className="mb-12 md:mb-20">
            ...
            >
              {keyFeatures.map((feature, index) => (
                <Card
                  key={index}
                  className="border-none shadow-lg md:shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-xl md:hover:shadow-2xl transition-all duration-300"
                >
                  <CardContent className="p-6 md:p-8">
                    <div className="flex items-center justify-center mb-4 md:mb-6">
                      <div
                        className={`p-3 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br ${feature.gradient}`}
                      >
                        {feature.icon}
                      </div>
                    </div>
                    ...
                    {feature.badges && (
                      <div className="flex justify-center space-x-2">
                        {feature.badges.map((badge, badgeIndex) => (
                          <Badge
                            key={badgeIndex}
                            className={`${feature.badgeColor} text-white text-xs md:text-sm`}
                          >
                            {badge}
                          </Badge>
                        ))}
          ...
          <div className="mb-12 md:mb-20" id="destinos">
            <div className="text-center mb-8 md:mb-16">
              <h3 className="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {popularDestinations.map((destination, index) => (
                <div
                  key={index}
                  className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-100"
                >
                  <div className="flex items-center justify-between mb-3 md:mb-4">
                    <div className="text-3xl md:text-4xl w-20 h-20">
                      <img src={destination.flag} alt={destination.name} />
                    </div>
                    <Badge
                      className={`${
                        destination.popularity === "Muy Popular"
                          ? "bg-red-500"
                          : destination.popularity === "Popular"
                          ? "bg-orange-500"
                          : destination.popularity === "Emergente"
                          ? "bg-blue-500"
                          : "bg-green-500"
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-full p-2 md:p-3 group-hover:scale-110 transition-transform duration-300 shadow-lg">
          ...
          <div className="mb-12 md:mb-20">
            <div className="text-center mb-8 md:mb-16">
              ...
              <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">
                Desde tu profesión hasta trabajos temporales, las opciones son
                infinitas
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-100 text-center group"
                >
                  <div
                    className={`w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 bg-gradient-to-r ${job.color} rounded-xl md:rounded-2xl flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
                    {job.icon}
                  </div>
          ...
          <div ref={ctaRef} className="text-center">
            <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 text-white">
              ...
              <p className="text-base md:text-xl mb-6 md:mb-8 max-w-3xl mx-auto opacity-90">
                Descubre todos los destinos disponibles y comienza a planificar
                tu experiencia de vida única trabajando y viajando por el mundo.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                <a
                  ...
                  className="border-2 border-white/30 text-white hover:bg-white/10 px-6 py-3 md:px-8 md:py-4 text-base md:text-lg font-semibold rounded-xl md:rounded-2xl backdrop-blur-sm inline-flex items-center justify-center transition-all duration-300"
                >
